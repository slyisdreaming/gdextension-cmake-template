...
/// Binds a property with a hint.
/// EXAMPLE: BIND_PROPERTY_WITH_HINT(ExampleNode, Variant::FLOAT, speed, PROPERTY_HINT_RANGE, "0, 20, 0.01");
#define BIND_PROPERTY_WITH_HINT(class_name, property_type, property_name, hint, hint_string) \
	...
	::godot::ClassDB::add_property(#class_name, ::godot::PropertyInfo(property_type, #property_name, hint, hint_string), "set_"#property_name, "get_"#property_name);

/// Binds a simple property: no hint and no the 'changed' signal.
#define BIND_PROPERTY(class_name, property_type, property_name) \
	BIND_PROPERTY_WITH_HINT(class_name, property_type, property_name, ::godot::PROPERTY_HINT_NONE, "")

/// Binds a property with the 'changed' signal.
/// For instance, if the property name is amplitude then the corresponding signal is amplitude_changed.
/// EXAMPLE: BIND_PROPERTY_WITH_SIGNAL(ExampleNode, Variant::FLOAT, amplitude);
#define BIND_PROPERTY_WITH_SIGNAL(class_name, property_type, property_name) \
...
/// Binds a property with a hint and the 'changed' signal.
#define BIND_PROPERTY_WITH_HINT_AND_SIGNAL(class_name, property_type, property_name, hint, hint_string) \
	BIND_PROPERTY_WITH_HINT(class_name, property_type, property_name, hint, hint_string) \
	ADD_SIGNAL(::godot::MethodInfo(#property_name"_changed", ::godot::PropertyInfo(property_type, "new_"#property_name)));

/// Binds enum property.
#define BIND_PROPERTY_ENUM(class_name, property_type, property_name, enum_values) \
	BIND_PROPERTY_WITH_HINT(class_name, property_type, property_name, ::godot::PROPERTY_HINT_ENUM, enum_values)

/// Binds enum property with the 'changed' signal.
#define BIND_PROPERTY_ENUM_WITH_SIGNAL(class_name, property_type, property_name, enum_values) \
...
#define EMIT_SIGNAL_PROPERTY_CHANGED(property_name) \
